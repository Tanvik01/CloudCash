...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // --------------------------------------------------------------------------
  const invoicesData = [
    { id: 'INV-2024-001', client: 'Acme Corp', email: 'billing@acmecorp.io', amount: 1200.00, issueDate: '01 Dec 2024', dueDate: '15 Dec 2024', status: 'Paid' },
    { id: 'INV-2024-002', client: 'Globex Inc', email: 'accounts@globex.org', amount: 450.00, issueDate: '05 Dec 2024', dueDate: '20 Dec 2024', status: 'Pending' },
    { id: 'INV-2024-003', client: 'Initech LLC', email: 'billing@initech.co', amount: 3100.00, issueDate: '10 Dec 2024', dueDate: '24 Dec 2024', status: 'Overdue' },
    { id: 'INV-2024-004', client: 'Umbrella Corp', email: 'finance@umbrellacorp.com', amount: 4250.00, issueDate: '12 Dec 2024', dueDate: '26 Dec 2024', status: 'Paid' },
    { id: 'INV-2024-005', client: 'Hooli Ltd', email: 'invoices@hooli.xyz', amount: 890.00, issueDate: '14 Dec 2024', dueDate: '28 Dec 2024', status: 'Pending' }
  ];
  ...
  function renderInvoices() {
    ...
    if (tbody) {
      ...
      invoicesData.forEach(inv => {
        ...
        const tr = document.createElement('tr');
        tr.className = `tactile-btn ${isSelected ? 'selected-row' : ''}`;
        tr.style.cursor = 'pointer';
        if (isSelected) tr.style.backgroundColor = 'var(--primary-light)';
        tr.innerHTML = `
